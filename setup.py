...
def get_version():
    try:
        f = open("sklearn_mmadsen/_version.py")
    except EnvironmentError:
        return None
...
setup(name="sklearn-mmadsen",
      #version=get_version(),
      version=get_version(),
      description="Additional classes and tools for ML and statistics built on top of scikit-learn, numpy, scipy, and various DNN libraries",
      packages = find_packages(exclude=["test", "testdata", "doc", "notebooks"]),
      scripts = [
      ],
      author='Mark E. Madsen',
      author_email='mark@madsenlab.org',
      url='https://github.com/mmadsen/sklearn-mmadsen',
      classifiers=[
